...
import MyPhoto from '../assets/Aakash.jpg'
      ...
      <div className='body'>
          <div className='body-left' >
              <div className='Hi-div' >
                <h1 className='hi'>👋 Hi, I’m Aakash S</h1>
              </div>
              <div className='about'>
              ...
              <div className='me' >
                ...
                <div className='contact'>
                    ...
                    <p className='contact-p' id='c2'>aakashmsd41@gmail.com</p>
                </div>
          ...
          <div className='body-right' >
            ...
            <div className='name' >
                <p className='name-para' >Aakash S</p>
            </div>
